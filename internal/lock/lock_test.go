...
func TestAcquireIssuesADistinctToken(t *testing.T) {
	...
	a, err := m.Acquire("ic7610", "oh7lzb", false)
	if err != nil {
	...
	if a.User != "oh7lzb" || a.RadioID != "ic7610" {
		t.Errorf("lock = %+v", a)
	}
...
func TestAcquireHeldByAnotherUser(t *testing.T) {
	...
	if _, err := m.Acquire("ic7610", "oh7lzb", false); err != nil {
		t.Fatalf("Acquire: %v", err)
	}
...
func TestAcquireBySameUserReissues(t *testing.T) {
	...
	a, _ := m.Acquire("ic7610", "oh7lzb", false)
	b, err := m.Acquire("ic7610", "oh7lzb", false)
	if err != nil {
...
func TestStealRequiresConfiguration(t *testing.T) {
	...
	a, _ = steal.Acquire("ic7610", "oh7lzb", false)
...
func TestCheckSlidesTheTTL(t *testing.T) {
	...
	l, _ := m.Acquire("ic7610", "oh7lzb", false)
	first := l.ExpiresAt
...
func TestInspectRedactsTheToken(t *testing.T) {
	...
	if got.User != "oh7lzb" || got.RadioID != "ic7610" {
